...
export default async function AdminInvoices() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10">
      <div className="flex justify-between"><h1 className="font-serif text-3xl text-primary">Hóa đơn</h1><Link href="/admin" className="text-sm text-muted">← Dashboard</Link></div>
